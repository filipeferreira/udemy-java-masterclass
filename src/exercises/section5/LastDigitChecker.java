...
public class LastDigitChecker {
    ...
    public static boolean hasSameLastDigit(int a, int b, int c) {
        ...
        int lastDigitNumberA = a % 10;
        int lastDigitNumberB = b % 10;
        int lastDigitNumberC = c % 10;

        return lastDigitNumberA == lastDigitNumberB || lastDigitNumberA == lastDigitNumberC || lastDigitNumberB == lastDigitNumberC;
